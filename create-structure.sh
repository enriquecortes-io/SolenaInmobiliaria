...
echo "🚀 Creando estructura de Solena Referrals..."

mkdir -p app/referidos
mkdir -p app/api/referrals/submit
mkdir -p components/Referrals

# 1. app/referidos/page.tsx
cat > app/referidos/page.tsx << 'EOF'
