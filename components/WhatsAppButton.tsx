...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent("Hola, me interesa conocer más sobre sus propiedades exclusivas en Marbella.");
