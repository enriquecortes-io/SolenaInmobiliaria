    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", justifySelf: "end" }}>
          <a href="https://www.instagram.com/solenainmo?igsh=MWtnMjJtNXZ2MWVpaw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" style={{ color: "#F5F0E8", opacity: 0.7, transition: "opacity 0.2s", display: "flex" }}
          ...
          <a href="https://www.facebook.com/SolenaInmobiliaria/" target="_blank" rel="noopener noreferrer" style={{ color: "#F5F0E8", opacity: 0.7, transition: "opacity 0.2s", display: "flex" }}
            onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.opacity = "1"}
            onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.opacity = "0.7"}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              display: "inline-block",
              color: "#C1694F",
              background: "linear-gradient(90deg, #C1694F 0%, #C4956A 45%, #C9A96E 100%)",
              WebkitBackgroundClip: "text",
              backgroundClip: "text",
              WebkitTextFillColor: "transparent",
            }}>
