    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", justifySelf: "end" }}>
          <a href="https://www.instagram.com/solenainmobiliaria" target="_blank" rel="noopener noreferrer" style={{ color: "#F5F0E8", opacity: 0.7, transition: "opacity 0.2s", display: "flex" }}
