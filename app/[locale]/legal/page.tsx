      ...
      <div style={{ maxWidth:"800px", margin:"0 auto" }}>
        ...
        <section style={S}>
          ...
          <ul style={{ ...P, paddingLeft:"1.5rem", lineHeight:2.2 }}>
            ...
            <li><strong style={{color:"#1A1714"}}>Web:</strong> theeditmarbella.com</li>
          </ul>
        </section>
        <section style={S}>
          <h2 style={H2}>2. Objeto y ámbito de aplicación</h2>
          <p style={P}>El presente Aviso Legal regula el acceso y uso del sitio web theeditmarbella.com, cuya actividad principal es la intermediación inmobiliaria de propiedades residenciales de lujo en la Costa del Sol. El acceso y uso de este sitio implica la aceptación plena de las presentes condiciones.</p>
        </section>
        <section style={S}>
        ...
        <div style={{ borderTop:"1px solid #DDD8D0", paddingTop:"2rem", marginTop:"4rem" }}>
          <a href="/" style={{ color:"#2D4A3E", fontSize:"0.5rem", letterSpacing:"0.4em", textTransform:"uppercase", textDecoration:"none" }}>← Volver</a>
        </div>
      </div>
    </div>
  );
