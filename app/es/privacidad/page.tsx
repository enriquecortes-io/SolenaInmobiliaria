...
export const metadata: Metadata = {
  title: "Política de Privacidad — Solena Inmobiliaria",
  robots: "noindex",
};
    ...
    <div style={{ minHeight:"100vh", background:"#FAFAF7", padding:"8rem clamp(2rem,10vw,12rem) 4rem", fontFamily:"'Montserrat','Helvetica Neue',sans-serif" }}>
      <div style={{ maxWidth:"800px", margin:"0 auto" }}>
        ...
        <section style={S}>
          ...
          <p style={P}>Enrique Cortés Gómez, con domicilio en Urb. La Alzambra, Centro de Negocios Vasari, Marbella, España. Email: Info@solenainmobiliaria.es</p>
        </section>
        <section style={S}>
        ...
        <section style={S}>
          ...
          <p style={P}>Tiene derecho a acceder, rectificar, suprimir, limitar el tratamiento y portabilidad de sus datos. Puede ejercer estos derechos enviando un email a Info@solenainmobiliaria.es. También tiene derecho a presentar una reclamación ante la Agencia Española de Protección de Datos (aepd.es).</p>
        </section>
