...
export const metadata: Metadata = {
  title: "Política de Cookies — Solena Inmobiliaria",
  robots: "noindex",
};
            ...
            <thead>
              <tr style={{ borderBottom:"1px solid #DDD8D0" }}>
                {["Cookie","Tipo","Finalidad","Duración"].map(h=>(
                  <th key={h} style={{ padding:"10px", textAlign:"left", color:"#1A1714", fontWeight:600, fontSize:"0.6rem", letterSpacing:"0.1em", textTransform:"uppercase" as const }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {[
                ["solena_session","Técnica","Mantener sesión del panel de administración","Sesión"],
                ["solena_cookie_consent","Preferencia","Recordar su elección sobre cookies","1 año"],
