...
const T = {
  es: {
    ...
    why_cards: [
      { number: '01', title: 'Red de colaboración', text: 'Tu propiedad en venta, en colaboración con más de 100 agencias en toda la Costa del Sol; Marbella, Benahavís, Estepona, Fuengirola, Benalmádena, Málaga, Torremolinos, Manilva, Sotogrande y las urbanizaciones intermedias. Toda la red trabaja para encontrar al comprador adecuado. Más agencias buscando. Más compradores llegando. Menos tiempo esperando.' },
